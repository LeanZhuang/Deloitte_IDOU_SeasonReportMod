...
# 触发判断部分仍需完善/注意的地方：1. category 4.减半差值>0，完整差值>0。 这部分由于数据缺失，目前代码处理是暂时跳过该类型的判断
...
# input_df1 = sys.argv[1]
# input_df2 = sys.argv[2]
# input_df3 = sys.argv[3]
# output_df = sys.argv[4]
# year_cmp = int(sys.argv[5])
# quarter_cmp= int(sys.argv[6])
input_df1 = '/Users/zhuangyuhao/PycharmProjects/SeasonRepMod/整合季报代码模型/dfs/原始科目数据_20230104.csv'
input_df2 = '/Users/zhuangyuhao/PycharmProjects/SeasonRepMod/整合季报代码模型/dfs/指标计算结果_20230104.csv'
input_df3 = '/Users/zhuangyuhao/PycharmProjects/SeasonRepMod/整合季报代码模型/dfs/阈值计算结果_20230104.csv'
# output_df = '/Users/zhuangyuhao/PycharmProjects/SeasonRepMod/整合季报代码模型/dfs/触发项目及触发等级_20230104.csv'
output_df = '/Users/zhuangyuhao/PycharmProjects/SeasonRepMod/整合季报代码模型/dfs/新数据22Q3_触发项目及触发等级_20230105.xlsx'
...
# 导入阈值触发表
df_threshold = pd.read_csv(input_df3)
# 导入指标数据
...
df_data = pd.melt(df_data,
                  id_vars=df_data.columns[:5],
                  value_vars=df_data.columns[5:],
                  var_name='code',
...
# df_category_2.to_excel('df2.xlsx')
...
# df_category_3.to_excel('df3.xlsx')
